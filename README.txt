...
Provide any special instructions to access or run your program.
    To run this program you will need the files AES_encrypt_decrypt.py & plaintext1.txt
    1. Start the program via command line
    2. You will be asked with a menu option to encrypt/decrypt/exit -- press '1' for encrypt
    3. You will need to enter in a file name, you can use the file "plaintext1.txt" or any file in your director 
    4. Now a new file will be created with the new encryption. This file should be called 'plaintext1.txt.enc' unless you choose a different file name
